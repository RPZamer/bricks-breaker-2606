...
void Game::Reset()
{
	...
	// Add 5 bricks in one row.
	for (int i = 0; i < 5; i++)
	{
		Box brick;
		brick.width = 10;
		brick.height = 2;
		brick.x_position = 6 + i * 14;
		brick.y_position = 5;
...
void Game::Render() const
{
	...
	if (gameOver)
	{
		...
		Console::WordWrap(22, WINDOW_HEIGHT / 2, 40, message);
	}
...
void Game::CheckCollision()
{
	...
	// Check the ball against every brick.
